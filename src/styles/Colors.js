...
export const primaryTint = "#000000";
export const secondaryTint = "#181819";
// export const primaryTint = "#282f33";
// export const secondaryTint = "#192226";
export const inactiveTint = "#5A5A5A";
export const primary = "#1cbbff";
